package com.ivan.garcia.materialtest;
...
import com.ivan.garcia.materialtest.Adapter.Adapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (adapter == null) {
            adapter = new Adapter(this, cardsList);
        }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                options = ActivityOptionsCompat.makeSceneTransitionAnimation(MainActivity.this, pair);

                Intent transitionIntent = new Intent(MainActivity.this, AddActivity.class);
                startActivityForResult(transitionIntent, adapter.getItemCount(), options.toBundle());
            }
        });
    }
