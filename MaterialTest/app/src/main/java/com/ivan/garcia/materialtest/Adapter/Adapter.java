package com.ivan.garcia.materialtest.Adapter;
...
import com.ivan.garcia.materialtest.EditActivity;
import com.ivan.garcia.materialtest.MainActivity;
import com.ivan.garcia.materialtest.Objects.Card;
import com.ivan.garcia.materialtest.R;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public Adapter(Context context, ArrayList<Card> cardsList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.initial.setBackgroundColor(color);
        holder.initial.setText(Character.toString(name.charAt(0)));
    }
        ...
        public ViewHolder(@NonNull View view) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Pair<View, String> p3 = Pair.create((View) deleteBtn, MainActivity.TRANSITION_DELETE_BUTTON);
                    ...
                    Intent transitionIntent = new Intent(context, EditActivity.class);
